...
% Test quearies with several programs, including the example shown in the lab PM
% These are executed when included in the interpreter
...
% This is the testcase from the lab pm. It should (and does) result in the state [x=1, y=6]
